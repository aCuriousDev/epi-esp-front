...
export const ASSET_FAVORITES: FavoriteAsset[] = [
  ...
  { path: '/assets/dungeon/floor_tile_small_decorated.gltf', label: 'Decorated floor tile', tag: 'ground' },
  ...
  { path: '/assets/dungeon/wall_archedwindow_open.gltf', label: 'Window', tag: 'wall' },
  { path: '/assets/dungeon/wall_broken.gltf', label: 'Broken wall', tag: 'wall' },
  { path: '/assets/dungeon/wall_cracked.gltf', label: 'Cracked wall', tag: 'wall' },
  ...
  { path: '/assets/dungeon/crates_stacked.gltf', label: 'Stacked crates', tag: 'prop' },
  ...
  { path: '/assets/dungeon/shelf_large.gltf', label: 'Shelf', tag: 'prop' },
  { path: '/assets/dungeon/keg.gltf', label: 'Baril', tag: 'prop' },
  { path: '/assets/dungeon/banner_red.gltf', label: 'Red banner', tag: 'prop' },
  { path: '/assets/dungeon/banner_blue.gltf', label: 'Blue banner', tag: 'prop' },
  ...
  { path: '/assets/dungeon/coin_stack_large.gltf', label: 'Coin stack', tag: 'resource' },
  { path: '/assets/dungeon/coin.gltf', label: 'Coin', tag: 'resource' },
  { path: '/assets/dungeon/key.gltf', label: 'Key', tag: 'resource' },
  { path: '/assets/dungeon/sword_shield.gltf', label: 'Sword & shield', tag: 'resource' },
  { path: '/assets/halloween/skull.gltf', label: 'Skull', tag: 'resource' },
