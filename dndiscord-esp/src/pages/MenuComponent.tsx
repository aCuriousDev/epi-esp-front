...
export default function MenuComponent() {
    ...
    const [menuItems,setMenuItems] = createSignal<Array<{label:string,icon?:JSX.Element,hoveringLabel:string,route:string,hoveringDescription?:string}>>([
        ...
        {label: 'Board Game (POC)', icon: <GameIconsCrossedSwords class="menu-badge-icon h-10 w-10" />, hoveringLabel: 'board', route: '/board',hoveringDescription:'Testez le système de combat tactique sur plateau.'},
