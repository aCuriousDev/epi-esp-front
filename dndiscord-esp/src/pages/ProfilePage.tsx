...
export default function ProfilePage() {
  ...
  const joinDate = () => {
    ...
    return new Date(u.createdAt).toLocaleDateString("fr-FR", {
      year: "numeric",
      month: "long",
      day: "numeric"
    });
  ...
  return (
    <div class="profile-page min-h-screen w-full bg-brand-gradient">
      {/* Background effects */}
      ...
      {/* Header */}
      <header class="relative z-20 flex items-center justify-between px-6 py-4 border-b border-white/10 bg-game-dark/50 backdrop-blur-sm">
        <button
          onClick={() => navigate("/")}
        ...
        <h1 class="font-display text-xl text-white">Mon Profil</h1>
